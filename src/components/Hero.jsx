...
const Hero = () => {
  const duplicatedSlides = [...slides, ...slides]; // For infinite loop effect
    ...
    <section className="bg-gradient-to-r from-gray-50 to-gray-50 py-24 px-6 md:px-10 text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 mb-16">
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1.2, ease: "easeOut" }}
          className="text-3xl md:text-5xl font-extrabold text-orange-500 leading-tight mb-6"
        >
          India’s First Human Sales-Powered Marketplace for Manufacturers
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-gray-700 mb-10"
        >
          No Fixed Cost. No Sales Team Needed. Pan-India Reach with Tech + People.
        </motion.p>

        

        <div className="flex flex-col md:flex-row justify-center gap-6">
          {/* Manufacturer Button - External */}
          <motion.a
          ...
          >
            I’m a Manufacturer – Get Started
          </motion.a>
          {/* Manufacturer Button - External */}
          <motion.a
            whileHover={{ scale: 1.05 }}
